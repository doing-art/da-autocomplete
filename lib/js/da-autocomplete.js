...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["DaAutocomplete"] = factory();
	else
		root["DaAutocomplete"] = factory();
})(this, function() {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	function hotDisposeChunk(chunkId) {
/******/ 		delete installedChunks[chunkId];
/******/ 	}
/******/ 	var parentHotUpdateCallback = this["webpackHotUpdateDaAutocomplete"];
/******/ 	this["webpackHotUpdateDaAutocomplete"] = 
...
/******/ 	var hotCurrentHash = "4999414c607d2eda781b"; // eslint-disable-line no-unused-vars
...
var _DaConfig = __webpack_require__(0);
...
var DaAutocomplete = function () {
    function DaAutocomplete(control, config) {
        _classCallCheck(this, DaAutocomplete);
        ...
        this._config = {};
        if (config) {
            for (var prop in _DaConfig2.default) {
                this._config[prop] = config[prop] || _DaConfig2.default[prop];
            }
        } else {
            for (var _prop in _DaConfig2.default) {
                this._config[_prop] = _DaConfig2.default[_prop];
            }
        }
    ...
    _createClass(DaAutocomplete, [{
        key: '_initSearch',
        value: function _initSearch() {
            var search = document.createElement('div');
            var placeholder = document.createElement('label');
            var control = this._controlExisting.cloneNode(true);
            var controlId = 'da-autocomplete-search-control-' + ++DaAutocomplete._counter;
        ...
        value: function _initTemplate() {
            ...
            var autocompleteParent = this._controlExisting.parentNode;
    ...
    return DaAutocomplete;
}();

exports.default = DaAutocomplete;
...
var DaHelpers = function DaHelpers() {
    _classCallCheck(this, DaHelpers);
};

exports.default = DaHelpers;
...
var _DaAutocomplete = __webpack_require__(1);

var _DaAutocomplete2 = _interopRequireDefault(_DaAutocomplete);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _DaAutocomplete2.default;
